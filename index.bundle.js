...
async function searchWeatherLocation(e){
  try{    
    ...
    const urlSearchApi = "https://api.weatherapi.com/v1/search.json?key=" + _ApiCreds__WEBPACK_IMPORTED_MODULE_0__.APIKEY_WEATHER_API + "&q="+valueToSearch;
...
async function getForecast(urlLocation){
  try{
    ...
    const urlSearchApi = "https://api.weatherapi.com/v1/forecast.json?key=" + _ApiCreds__WEBPACK_IMPORTED_MODULE_1__.APIKEY_WEATHER_API + "&q="+valueToSearch + "&days=3";
